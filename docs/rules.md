...
The rules are the standard Yahtzee rules: 2–6 players per table, 13 rounds; each turn you get up to three rolls of
...
your six upper categories total 63+. Extra fives of a kind: +100 each while your Five of a Kind
box holds 50, with the standard joker placement rules.
