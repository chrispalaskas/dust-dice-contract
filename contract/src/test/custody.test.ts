 ...
 * b0c93a40887c9547b6d7b13de74c1cfcbcfdd96e0f70735eb3082d0ee1bc9e4a at block 112 (the second
 * join) of a local ledger-9 chain running the oracle-map VRF contract (the `npm run demo -w cli` table,
