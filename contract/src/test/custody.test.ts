...
describe(
  ...
  {
    skip:
      'fixtures/table-state-two-seats.hex predates the `vrfAnswer` map (2026-09-21), which ' +
      'rebalanced the ledger buckets again. Recapture it from a live table once one has two ' +
      'seats joined -- the same way the 2026-09-21 capture was made (block of the second join).',
  },
  () => {
